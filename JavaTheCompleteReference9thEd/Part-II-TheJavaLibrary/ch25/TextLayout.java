...
/*  <title>Text layout</title>
    <applet code="TextLayout" height=200 width=200>
      <param name="text" value="You probably haven't heard of them poke snackwave, DIY craft beer single-origin coffee mlkshk echo park butcher authentic blue bottle letterpress scenester.<p> Air plant flexitarian cliche bicycle rights freegan, sartorial pug intelligentsia deep v.">
...
class MyMouseAdapter extends MouseAdapter {
  ...
  public MyMouseAdapter(TextLayout t1){
      this.t1 = t1;
  }

  public void moseClicked(MouseEvent me){
